...
public class tree{
	...
	public int heightIndex; // the nodes index at it's height in the tree (not actually needed I think)
	...
	public tree(int newHeightIndex, int newValue, char[] newPath, tree newLeft, tree newRight){
